                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <input type="number" value="{{ $bill->transport }}" onblur="updateTransport({{$bill->id}})" name="transport" id="transport" class="form-control">
                        </div>
                    </div>
                </div>
...
function updateTransport(id){
    ...
    var val = $("#transport").val();
    $.ajax({
        method: "GET",
        url: "{{url('/sale/update/transport/')}}/"+{{ $bill->id }}+"/"+val,
        success: function(respose){
            get_items();
            Snackbar.show({
            text: "Transport Updated",
            duration: 3000,
            /* actionTextColor: '#fff',
            backgroundColor: '#e7515a' */
            actionTextColor: '#fff',
